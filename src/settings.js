...
//   FT4:  -17.5 (2500) + 14.0 = -3.5 (100 Hz)
//   WSPR: -28   (2500) + 20.0 = -8   (25 Hz)
//   CW:    0    (500)                            [trained-ear native, ARRL Handbook]
//   SSB:  10    (2500)                           [comfortable-copy native, ARRL Handbook]
// FT4 note (2026-07-10): the earlier -16.4 dB was the pre-release FT4
// candidate figure; the published final-protocol threshold (Franke,
// Somerville & Taylor, "The FT4 and FT8 Communication Protocols") is
// -17.5 dB at 2500 Hz.
export const MODE_SNR_DB = {
  ft8:  -4,     // at  50 Hz, from -21 dB / 2500 Hz
  ft4:  -3.5,   // at 100 Hz, from -17.5 dB / 2500 Hz (WSJT-X published)
