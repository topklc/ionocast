...
if (JSON.stringify(a.pressure_levels_hpa) !== JSON.stringify(b.pressure_levels_hpa)) {
  console.error(`pressure-level mismatch: ${a.pressure_levels_hpa} vs ${b.pressure_levels_hpa}`);
  process.exit(1);
}
