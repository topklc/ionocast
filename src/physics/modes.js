...
//
// Reference points (recomputed 2026-07-10; the earlier table was
// hand-rounded off-curve at several anchors):
//   f107=70  (solar min):    9.0 dB
//   f107=100 (low-moderate): 10.1 dB
//   f107=125 (mid):          11.5 dB (sigmoid midpoint)
//   f107=150 (high-moderate):12.9 dB
//   f107=180 (peak):         14.0 dB
//   f107=220 (extreme peak): 14.7 dB (asymptotes to 15)
