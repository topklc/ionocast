#!/usr/bin/env node
// scripts/tests/harness-unit.mjs
//
// Unit tests for harness.mjs internals. Run with:
//   node scripts/tests.mjs --suite=harness-unit
//
...
// ── 5. replayMargin: reproduces hand-computed budget ──────────────────
{
  ...
  // Per-band base σ for 20 m is 9 after the BAND_SIGMA_DB recalibration
  // (was 6 pre-retune; see src/constants.js). Falls back to
  // config.sigmaBaseDb when perBandSigma=false.
